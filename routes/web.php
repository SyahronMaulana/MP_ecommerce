...
route::get('store/buy/{penjualan:slug}',[BuyController::class,'index']);
route::get('store/checkout/{penjualan:name}',[BuyController::class,'buy']);
route::post('store/checkout/{penjualan:harga}',[BuyController::class,'buyer']);
